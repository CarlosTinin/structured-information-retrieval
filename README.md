...
---
2. Add inter-annotator agreement (IAA) metrics for segmentation
...
---
3. Implement a schema-validated gold standard for segmentation and NER
...
---
4. Evaluate the pipeline end-to-end against a no-filtering baseline
...
---
5. Add explainability output to Stage2 classification
...
---
6. Benchmark against a Portuguese-law LLM baseline for Stage2
...
---
7. Report pipeline runtime and LLM cost profile
