...
Include a full activity diagram showing stage1\_1 $\rightarrow$ stage1\_2 $\rightarrow$ stage2 $\rightarrow$ stage3 $\rightarrow$ stage5.
...
\subsection{Stage5: Legal-domain NER extraction}
\begin{itemize}
...
\begin{itemize}
    ...
    \item Future work: stage4 integration, active learning, expert-in-the-loop verification.
\end{itemize}
